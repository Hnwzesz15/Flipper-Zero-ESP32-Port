...
static const char* funny_ssids[] = {
    "Pretty Fly for a WiFi", "Not Your WiFi", "The Promised LAN",
    "Abraham Linksys", "Bill Wi the Science Fi", "Silence of the LANs",
    "Router? I Hardly Know Her", "Wu-Tang LAN", "Searching...",
    "The Internet", "Loading...", "FBI Surveillance Van #3",
    "CIA Listening Post", "Yell \"Password\" for Password", "No More Mister WiFi",
    "GetOffMyLawn", "HideYoKidsHideYoWiFi", "The LAN Before Time",
    "Help I'm Trapped in a Router", "Winternet Is Coming",
    "Game of Phones", "It Hurts When IP", "LAN Solo",
    "Darth Vader's Summer Home", "The Nacho Network", "PrettyPrincessNetwork",
    "Definitely Not Skynet", "This Is Not Free WiFi", "Your Music Is Annoying",
    "Stop Being Nosy", "Go Home Tourists", "Ermahgerd WiFi",
    "NetworkNotFound", "I'm Watching You", "No Pants No Service",
    "The Batcave", "Wayne Manor Guest", "Nakatomi Plaza",
    "Couch Fortress Internet", "Mom Use This One", "Dad Use This One",
    "Kids Stay Off This", "Never Gonna Give You WiFi", "Password Is Password",
    "Wrong Password", "Correct Password", "Keep Trying",
    "It's a Trap", "Dunder Mifflinets", "Dwight's Beet Farm",
    "Michael Scotts Hotspot", "The Office LAN Party", "Pawnee Eagleton Rivalry",
    "Hogwarts Great Hall WiFi", "Platform 9 and Three Quarters", "Dumbledore's Army HQ",
    "One Does Not Simply Log In", "Mordor Guest Network", "The Shire Broadband",
    "Skyrim Broadband Co.", "Winterfell Wireless", "Castle Black Hotspot",
    "The Night's Watch Network", "This Is the WAN", "Baby Yoda's Hotspot",
    "Use the Force Luke", "Obi-WAN Kenobi", "These Aren't the Droids",
    "Alderaan Public WiFi", "Death Star Employee Network", "Jurassic Park Main Gate",
    "Your Fridge Is Online", "Virus.exe", "NotAVirus",
    "Totally Legit Network", "Free Candy Van WiFi", "The Quiet Router",
    "Shh I'm Working", "My Neighbors Are Loud", "Apartment 4B's Internet",
    "Stealthy McStealthface", "International WiFi of Mystery", "SpyNet Terminal 7",
    "Russian Bot Network", "Area 51 Intranet", "Illuminati Confirmed",
    "Flat Earth HQ", "Bigfoot's Hideout", "Aliens Did This",
    "The Matrix Has You", "Simulation Network", "Buffering Eternal",
    "Ping Me Maybe", "404 Network Not Found", "Error 503 No Service",
    "This Is Fine", "Too Many Devices", "I Can Haz Internetz",
    "Your Cat Is On My Roof", "Shut Up and Connect",
    NULL
};
